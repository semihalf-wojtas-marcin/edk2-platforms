...
MV_PCIE_CONTROLLER mPcieController[] = {
  ...
  { // CP0 PCIE2 @0xF2640000
    .PcieDbiAddress        = 0xF2640000,
    .ConfigSpaceAddress    = 0x910000000,
    .HaveResetGpio         = FALSE,
    .PcieResetGpio         = { 0 },
    .PcieBusMin            = 0,
    .PcieBusMax            = 0xFE,
    .PcieIoTranslation     = 0x91FF00000,
    .PcieIoWinBase         = 0x0,
    .PcieIoWinSize         = 0x10000,
    .PcieMmio32Translation = 0,
    .PcieMmio32WinBase     = 0xF8000000,
  ...
  { // CP1 PCIE0 @0xF4600000
    ...
    .ConfigSpaceAddress    = 0x920000000,
    .HaveResetGpio         = FALSE,
    .PcieResetGpio         = { 0 },
    .PcieBusMin            = 0,
    .PcieBusMax            = 0xFE,
    .PcieIoTranslation     = 0x92FF00000,
    .PcieIoWinBase         = 0x0,
    .PcieIoWinSize         = 0x10000,
    .PcieMmio32Translation = 0,
    .PcieMmio32WinBase     = 0xFA000000,
    .PcieMmio32WinSize     = 0x1000000,
    .PcieMmio64Translation = 0,
    .PcieMmio64WinBase     = MAX_UINT64,
    .PcieMmio64WinSize     = 0,
  ...
  { // CP1 PCIE1 @0xF4620000
    ...
    .ConfigSpaceAddress    = 0x930000000,
    .HaveResetGpio         = FALSE,
    .PcieResetGpio         = { 0 },
    .PcieBusMin            = 0,
    .PcieBusMax            = 0xFE,
    .PcieIoTranslation     = 0x93FF00000,
    .PcieIoWinBase         = 0x0,
    .PcieIoWinSize         = 0x10000,
    .PcieMmio32Translation = 0,
    .PcieMmio32WinBase     = 0xFB000000,
    .PcieMmio32WinSize     = 0x1000000,
    .PcieMmio64Translation = 0,
    .PcieMmio64WinBase     = MAX_UINT64,
    .PcieMmio64WinSize     = 0,
  ...
  { // CP1 PCIE2 @0xF4640000
    ...
    .ConfigSpaceAddress    = 0x940000000,
    .HaveResetGpio         = FALSE,
    .PcieResetGpio         = { 0 },
    .PcieBusMin            = 0,
    .PcieBusMax            = 0xFE,
    .PcieIoTranslation     = 0x94FF00000,
    .PcieIoWinBase         = 0x0,
    .PcieIoWinSize         = 0x10000,
    .PcieMmio32Translation = 0,
    .PcieMmio32WinBase     = 0xFC000000,
    .PcieMmio32WinSize     = 0x1000000,
    .PcieMmio64Translation = 0,
    .PcieMmio64WinBase     = MAX_UINT64,
    .PcieMmio64WinSize     = 0,
